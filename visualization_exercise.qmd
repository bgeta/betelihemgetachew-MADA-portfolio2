...
I hope we can make this chart a lot better and closer to the original chart.
...
#in order to use line chart with multiple variables we #first need to change the df from wide to long using the melt function
