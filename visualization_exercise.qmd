...
Data summary. The available data varies from the year 1786 to 2022 for Gunfire, Assault/Stabbing, 9/11 and related illness, COVID and other.
...
#I tried adding the theme_fivethirtyeight to match the aesthetics but it doesnt look like it worked? The code I used to remove the legend title variable didnt seem to work either.

```{r}
ggplot(data_long1,aes(x=Year,y=value, fill=variable))+geom_area()+
ggtitle("On-duty police officer in the U.S. 
By cause since 1786") + theme(legend.position=c(.25,.75)) + theme(legend.title=element_blank()+ theme_fivethirtyeight())+ annotate(geom="text",x=2001,y=72, label ="72 police
                                                                                                                                   officeres died
                                                                                                                                   in teh 9/11 
                                                                                                                                   terrorist attack", hjust="top")
```
